...
@interface ZMCheatScoreResultVC ()
...
@implementation ZMCheatScoreResultVC
...
- (void)initSubviews {
    ...
    if (self.result) {
        ...
        self.scoreTF = [[TLTextField alloc] initWithFrame:CGRectMake(0, promptLabel.yy + kWidth(35), kScreenWidth, 50) leftTitle:@"申请欺诈评分" titleWidth:115 placeholder:@""];
        
        self.scoreTF.text = self.score;
